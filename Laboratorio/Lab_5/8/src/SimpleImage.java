 ...
 * can be read from a file in JPEG, GIF, or PNG format, or the user can create a
 * blank image of a given size. Includes methods for saving to a file.
 * 
 * Remarks ------- - pixel (0, 0) is upper left hand corner
 *
 * - if JPEG read in is in grayscale, then you can only set the color to a
 * graycale value
 * 
